...
const LEGAL_CONTENT: Record<string, { title: string; html: string }> = {
  privacy: {
    ...
    html: `
      ...
      <li>
      <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Buildorai.com, One Sansome Street, San Francisco, CA 94104, USA.</p>
      </li>
      <li>
      ...
      <li>
      <p><strong>Website</strong> refers to Buildorai.com, accessible from <a href="https://buildorai.com" rel="external nofollow noopener" target="_blank">https://buildorai.com</a>.</p>
      </li>
      <li>
      ...
      <ul>
      <li>By email: help@buildorai.com</li>
      </ul>
    `
  },
  terms: {
...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to Buildorai.com, One Sansome Street, San Francisco, CA 94104, USA.</p>
</li>
<li>
<p><strong>Device</strong> means any device that can access the Service such as a computer, a cell phone or a digital tablet.</p>
</li>
...
<ul>
<li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to Buildorai.com, One Sansome Street, San Francisco, CA 94104, USA.</li>
<li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
<li><strong>Website</strong> refers to Buildorai.com, accessible from <a href="https://buildorai.com" rel="external nofollow noopener" target="_blank">https://buildorai.com</a>.</li>
...
export default function Footer() {
  const [status, setStatus] = useState<"idle" | "submitting" | "success" | "alreadySubscribed" | "error">("idle");
  const [activeLegal, setActiveLegal] = useState<string | null>(null);

  useEffect(() => {
    const isSubscribed = localStorage.getItem("buildorai_subscribed");
    if (isSubscribed) {
  ...
  const handleSubscribe = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/mojpzded", {
        method: "POST",
      ...
      if (response.ok) {
        setStatus("success");
        localStorage.setItem("buildorai_subscribed", "true");
      } else {
        setStatus("error");
      }
    } catch (error) {
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10">
            ...
            <div className="w-full max-w-md">
              {(status === "success" || status === "alreadySubscribed") ? (
                <div className="flex items-center gap-4 rounded-2xl bg-primary/10 p-6 border border-primary/20 backdrop-blur-md">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-primary text-white">
                    <Check size={24} />
                  </div>
                  <div className="text-left">
                    <p className="font-bold text-white">You're on the list!</p>
                    <p className="text-sm text-text-secondary">Welcome to the inner circle.</p>
                  </div>
                </div>
              ) : (
                <>
                  ...
                  <p className="mt-4 text-center lg:text-left text-xs text-text-secondary opacity-60">
                    {status === "error" ? (
                      <span className="text-red-400 font-bold">Something went wrong. Try again?</span>
        ...
        <div className="grid gap-x-8 gap-y-12 grid-cols-2 lg:grid-cols-4 items-start text-left">
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="flex gap-6 justify-start">
              ...
              <a href="https://www.linkedin.com/company/buildorai/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
        ...
        {activeLegal && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 sm:p-6">
            ...
            <motion.div
              ...
              className="relative flex h-full max-h-[80vh] w-full max-w-3xl flex-col overflow-hidden rounded-[2.5rem] border border-primary/20 bg-surface/80 shadow-2xl backdrop-blur-3xl"
            >
              <div className="flex items-center justify-between border-b border-white/5 p-6 sm:px-10">
                <h2 className="text-2xl font-bold tracking-tight text-white sm:text-3xl">
                  {LEGAL_CONTENT[activeLegal].title}
                </h2>
                <button
                  onClick={() => setActiveLegal(null)}
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 text-primary transition-all hover:bg-primary hover:text-white active:scale-95"
                >
                  <X size={20} />
                </button>
              </div>
              <div className="flex-1 overflow-y-auto p-6 sm:p-10 legal-scrollbar">
                <style dangerouslySetInnerHTML={{
                  __html: `
                  .legal-scrollbar::-webkit-scrollbar {
                    width: 6px;
                  }
                  .legal-scrollbar::-webkit-scrollbar-track {
                    background: rgba(255, 255, 255, 0.05);
                    border-radius: 10px;
                  }
                  .legal-scrollbar::-webkit-scrollbar-thumb {
                    background: var(--primary, #0EA5E9);
                    border-radius: 10px;
                  }
                  .legal-scrollbar::-webkit-scrollbar-thumb:hover {
                    background: var(--primary-dark, #0284C7);
                  }
                `}} />
                <div
                  className="prose prose-invert max-w-none 
                    [&>h2]:text-primary [&>h2]:text-xl [&>h2]:font-bold [&>h2]:mt-8 [&>h2]:mb-4
                    [&>p]:text-text-secondary [&>p]:leading-relaxed [&>p]:mb-6"
                  dangerouslySetInnerHTML={{ __html: LEGAL_CONTENT[activeLegal].html }}
                />
              </div>
              <div className="border-t border-white/5 bg-background/50 p-6 text-center">
                <p className="text-xs text-text-secondary opacity-50 uppercase tracking-[0.2em] font-bold">
