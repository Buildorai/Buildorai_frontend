...
const BuildorAIProductPage = () => {
  return (
    <div className="bg-[#020617] text-white font-sans selection:bg-[#0EA5E9]/30 pt-20 px-10">
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-6xl sm:text-7xl lg:text-8xl font-extrabold tracking-tight leading-[1.1] mb-6 font-heading">
            ...
            <div className="flex flex-wrap gap-4">
              <button className="bg-[#0EA5E9] hover:bg-[#0EA5E9]/90 text-white px-8 py-4 rounded-xl font-semibold transition-all flex items-center gap-2 group shadow-lg shadow-[#0EA5E9]/20 hover:scale-105 active:scale-95">
                Get Started with BuildorAI
                <Zap className="w-4 h-4 group-hover:fill-current" />
              </button>
              <button className="bg-white/5 hover:bg-white/10 border border-white/10 text-white px-8 py-4 rounded-xl font-semibold transition-all hover:border-white/20 active:scale-95">
                Watch Demo
              </button>
            </div>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                key={idx} 
                whileHover={{ y: -5 }}
                className="p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-[#0EA5E9]/50 transition-all group backdrop-blur-sm"
              >
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="order-1 lg:order-2 bg-surface border border-white/10 rounded-3xl p-12 text-center relative group">
            ...
            <div className="inline-flex items-center gap-2 text-[#0EA5E9] font-bold tracking-[0.2em] text-sm bg-[#0EA5E9]/10 py-2 px-6 rounded-full border border-[#0EA5E9]/20">
              <Cpu className="w-5 h-5" /> POWERED BY H100 TENSOR CORE
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 relative group overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <button className="bg-[#0EA5E9] hover:scale-105 transition-all text-white px-10 py-5 rounded-2xl font-bold text-lg shadow-xl shadow-[#0EA5E9]/30 active:scale-95">
              Get Started with Buildorai.com
            </button>
            <button className="bg-white/5 border border-white/10 hover:bg-white/10 text-white px-10 py-5 rounded-2xl font-bold text-lg transition-all active:scale-95 hover:border-white/20">
              Contact Sales
            </button>
          </div>
        </div>
